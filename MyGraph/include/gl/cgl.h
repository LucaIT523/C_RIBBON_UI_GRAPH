...
protected:
	...
	void RenderGradient(LPRECT lpRect, GRAPH_GRADIENTTYPE grType, COLORREF color1, COLORREF color2);
	void RenderSolid(LPRECT lpRect, COLORREF color);
	void SetGLColor(COLORREF color);
private:
