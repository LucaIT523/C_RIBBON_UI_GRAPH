...
void CSimpleDIB::GetSize(CSize* pSize)
{
	*pSize = m_sizeDIB;
}

void CSimpleDIB::CheckDIBSize(int cx, int cy, int ibitcount)
{
/*
	CSize sz;
	GetSize(&sz);
...
*/
	if (m_sizeDIB.cx != cx || m_sizeDIB.cy != cy)
		Create(cx, cy, ibitcount);
}
